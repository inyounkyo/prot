package in.moduler.practice.ehcache.service;

import in.moduler.practice.ehcache.mapper.CharacterMapper;
...
public class SampleService {
    ...
    public in.moduler.practice.ehcache.model.Character getMybatisDataNonCaching(Long id) {

        return findDataFromDB(id);
    }

    @Cacheable(value = "mybatis", key = "#id")
    public in.moduler.practice.ehcache.model.Character getMybatisDataCaching(Long id) {
     ...
     * @return
     */
    private in.moduler.practice.ehcache.model.Character findDataFromDB(Long id) {

        in.moduler.practice.ehcache.model.Character character = null; //mapper.findById(id);
